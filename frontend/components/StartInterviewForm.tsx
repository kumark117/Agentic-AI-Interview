  ...
  return (
    <main className="start-page">
      <header className="start-hero">
        ...
        <p className="start-report-hint" role="note">
          {form.interview_mode === "llm" ? (
            ...
            <>
              With <strong>Mock</strong> selected, <strong>Correct Answers Report</strong> is not available (it runs only for{" "}
              <strong>AI LLM</strong> sessions after you finish). Switch the engine above if you want that reference report.
            </>
          )}
        </p>
      </header>
